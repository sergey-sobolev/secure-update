...
1. диаграмму последовательности вызовов
2. все скомпрометированные компоненты должны быть выделены красным цветом
...
Результат: не достижение цели безопасности №1: обновление не проверено
...
Результат: не достижение цели безопасности №1: возможно обновление некорректным файлом
...
Результат: не достижение цели безопасности №1: обновление непроверенным файлом
